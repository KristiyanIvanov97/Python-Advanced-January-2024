...
def register():
    ...
    frame.create_text(250, 50, text="First Name:")
    frame.create_text(250, 100, text="Last Name:")
    frame.create_text(250, 150, text="Username:")
    frame.create_text(250, 200, text="Password:")

    frame.create_window(370, 50, window=first_name_box)
    frame.create_window(370, 100, window=last_name_box)
    frame.create_window(370, 150, window=username_box)
    frame.create_window(370, 200, window=password_box)
